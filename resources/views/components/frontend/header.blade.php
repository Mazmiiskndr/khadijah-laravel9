                            ...
                            <div class="icon-nav">
                                <ul>
                                    <li class="onhover-div mobile-search">
                                        <div><img src="{{ asset('assets/assets/images/icon/search.png') }}" onclick="openSearch()"
                                    ...
                                    <li class="onhover-div mobile-setting">
                                        <div><img src="{{ asset('assets/assets/images/icon/setting.png') }}"
                                    ...
                                    <li class="onhover-div mobile-cart">
                                        <div><img src="{{ asset('assets/assets/images/icon/cart.png') }}"
