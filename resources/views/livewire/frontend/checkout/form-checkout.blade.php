                        ...
                        <ul>
                            <li>
                                <div class="radio-option">
                                    ...
                                    <label for="payment-1">Check Payments<span class="small-text">Please send a check to
                                            Store
                            ...
                            <li>
                                <div class="radio-option">
                                    ...
                                    <label for="payment-2">Cash On Delivery<span class="small-text">Please send a check to
                                            Store
                                            Name, Store Street, Store Town, Store State /
                                            County, Store Postcode.</span></label>
                                </div>
                            ...
                            <li>
                                <div class="radio-option paypal">
                                    ...
                                    <label for="payment-3">PayPal<span class="image"><img src="../assets/images/paypal.png"
                                                alt=""></span></label>
                                </div>
                            </li>
                        </ul>
