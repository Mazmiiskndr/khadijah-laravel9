...
// console.log(pageWrapper.classList.contains("compact-wrapper"));
// console.log(document.querySelector(".simplebar-wrapper .simplebar-content-wrapper a"));
...
// Get current URL
    ...
    // Find <a> elements that have href attribute equal to current URL
    var $activeLink = $('.simplebar-content-wrapper a[href="' + currentURL + '"]');

    // Add 'active' class to those elements
    $activeLink.addClass('active');

    // Find parent '.sidebar-list' of the active link and add 'active' class
    $activeLink.parents('.sidebar-list').find('.sidebar-link.sidebar-title').addClass('active');

    // Display the submenu that contains the active link
    $activeLink.parents('.sidebar-submenu').css('display', 'block');